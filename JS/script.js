...
const categories = ['all',  'updates',  'events'];
// array describing the colors matching the categories
const colors = ['#66d7ee', '#7166ee', '#66a1ee'];
...
var fillerTitle = ['End semester paper, practical exams and technical fest events- all coming soon. Stay TUNED!'];
var random = ['hello'];
